...
//Initializes the window and timer. Builds the initial scene.
...
//Main game loop. Starts the timer, the updates, and renders the current scene.
...
//Runs the current scene's OnCreate() function
